			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"byemtaui-display": {
								"semanticObject": "byemtaui",
								"action": "display",
								"description": "Bye MTA UI",
								"title": "Bye MTA UI",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=byemtaui",
									"url": sap.ui.require.toUrl("byemtaui")
								}
							}
						}
					}
